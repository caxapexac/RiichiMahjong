...
public final class MahjongTileItems {
    ...
    private static final RegistrySupplier<Block>[] TILE_BLOCKS_BY_CODE = new RegistrySupplier[TILE_COUNT];

    @SuppressWarnings("unchecked")
    private static final RegistrySupplier<Item>[] TILE_ITEMS_BY_CODE = new RegistrySupplier[TILE_COUNT];
    ...
    private static void registerTile(DeferredRegister<Block> blocks, DeferredRegister<Item> items,
                                     int code, String id) {
        RegistrySupplier<Block> blockRo =
    ...
    public static Block blockForCode(int code) {
        ...
        RegistrySupplier<Block> ro = TILE_BLOCKS_BY_CODE[code];
        return ro == null ? null : ro.get();
    }
    ...
    public static List<Item> allTileItems() {
        ...
        for (RegistrySupplier<Item> ro : TILE_ITEMS_BY_CODE) {
            if (ro != null) {
                out.add(ro.get());
            }
        }
    ...
    public static List<Block> allTileBlocks() {
        ...
        for (RegistrySupplier<Block> ro : TILE_BLOCKS_BY_CODE) {
            if (ro != null) {
                out.add(ro.get());
            }
        }
