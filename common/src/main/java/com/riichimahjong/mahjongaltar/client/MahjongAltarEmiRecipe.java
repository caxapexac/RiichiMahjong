...
public final class MahjongAltarEmiRecipe extends BasicEmiRecipe {
    ...
    public MahjongAltarEmiRecipe(EmiRecipeCategory category, ResourceLocation id, MahjongAltarRecipe recipe) {
        super(category, id, 112, 68);
        this.recipe = recipe;
    ...
    public void addWidgets(WidgetHolder widgets) {
        ...
        widgets.addText(
                Component.translatable("riichi_mahjong.emi.mahjong_altar.min_han", recipe.minHan()),
                0,
                TEXT_Y,
                0x404040,
                false);
