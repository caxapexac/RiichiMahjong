...
public final class MahjongTableHoverHintClient {
    ...
    private static final String K_CENTER = "riichi_mahjong_forge.hint.table.center";
    private static final String K_EDGE_OPEN_EMPTY = "riichi_mahjong_forge.hint.table.edge.open_empty";
    private static final String K_EDGE_OPEN_SELF = "riichi_mahjong_forge.hint.table.edge.open_self";
    private static final String K_EDGE_OPEN_OTHER = "riichi_mahjong_forge.hint.table.edge.open_other";
    private static final String K_EDGE_CLOSED = "riichi_mahjong_forge.hint.table.edge.closed";
