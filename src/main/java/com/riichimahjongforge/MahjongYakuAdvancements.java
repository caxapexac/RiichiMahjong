...
public final class MahjongYakuAdvancements {
    ...
    private static final ResourceLocation ROOT_ID =
            ResourceLocation.fromNamespaceAndPath(RiichiMahjongForgeMod.MODID, "yaku/root");
    ...
    public static void awardForWin(
        ...
        for (String key : canonicalKeys) {
            grant(winner, ResourceLocation.fromNamespaceAndPath(RiichiMahjongForgeMod.MODID, "yaku/" + key));
        }
    }
