...
public final class CuteEditor {
    ...
    public static void drawTriad(PoseStack pose, MultiBufferSource buffers,
        ...
        HoverHighlightRenderer.line(vc, m, n, ax, ay, az, ax + TRIAD_LEN, ay, az,        i, 0f, 0f, 1f);
        HoverHighlightRenderer.line(vc, m, n, ax, ay, az, ax, ay + TRIAD_LEN, az,        0f, i, 0f, 1f);
        HoverHighlightRenderer.line(vc, m, n, ax, ay, az, ax, ay, az + TRIAD_LEN,        0f, 0f, i, 1f);
        if (isSelected) {
            float c = TRIAD_LEN * 0.4f;
            HoverHighlightRenderer.line(vc, m, n, ax - c, ay, az, ax + c, ay, az, 1f, 1f, 0f, 1f);
            HoverHighlightRenderer.line(vc, m, n, ax, ay - c, az, ax, ay + c, az, 1f, 1f, 0f, 1f);
            HoverHighlightRenderer.line(vc, m, n, ax, ay, az - c, ax, ay, az + c, 1f, 1f, 0f, 1f);
        }
    }
