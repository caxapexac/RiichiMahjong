...
public enum MahjongScore {
    ...
    MahjongScore(int ron, int parentTsumo, int parent, int child) {
        this.ron = ron;
    ...
    public static MahjongScore calculateYakumanScore(boolean isParent, int yakumanSize) {
        switch (yakumanSize) {
            case 1:
                return isParent ? SCORE48000 : SCORE32000;
            // TODO: double yakuman, triple yakuman, etc.
        }
        return SCORE0;
    }

    public static MahjongScore calculateScore(boolean isParent, int han, int fu) {
        if (han >= 13) {
            return isParent ? SCORE48000 : SCORE32000;
        }
        switch (han) {
    ...
    private static MahjongScore calc4Han(boolean isParent, int fu) {
    ...
    private static MahjongScore calc3Han(boolean isParent, int fu) {
    ...
    private static MahjongScore calc2Han(boolean isParent, int fu) {
    ...
    private static MahjongScore calc1Han(boolean isParent, int fu) {
